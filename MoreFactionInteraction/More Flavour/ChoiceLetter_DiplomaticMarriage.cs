        ...
        public override IEnumerable<DiaOption> Choices
        {
            get
            {
                ...
                else
                {
                    ...
                    DiaNode dialogueNodeReject = new DiaNode(text: "MFI_DejectedProposal".Translate(this.marriageSeeker.Label, this.marriageSeeker.Faction).CapitalizeFirst().AdjustedFor(this.marriageSeeker));
